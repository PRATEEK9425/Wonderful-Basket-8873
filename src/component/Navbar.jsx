...
<GridItem style={{ display: "flex", gap:"20px" , width:"400px" ,marginLeft:"-100px" ,
     ...
     <Link style={{textDecoration :"none" , color:"Black" ,fontWeight:"bold"}}to="/men">Men</Link>
...
<GridItem>
<Input placeholder="Search for Products , brand and more" style={{height:"25px",width:"450px",marginLeft:"100px", borderRadius:"5px"}}  />
</GridItem>
