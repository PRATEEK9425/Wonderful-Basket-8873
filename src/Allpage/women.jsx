...
axios.get("http://localhost:3001/wpost1").then((res)=>setData(res.data))
axios.get("http://localhost:3001/wpost2").then((res)=>setData1(res.data))
axios.get("http://localhost:3001/wpost3").then((res)=>setData2(res.data))
axios.get("http://localhost:3001/post4").then((res)=>setData4(res.data) )
axios.get("http://localhost:3001/wpost4").then((res)=>setData5(res.data))
...
<div>
    <Box>
        <Image src="https://i.pinimg.com/originals/fd/1e/cc/fd1ecc7f6d8b956809ee7e5c055cdf9b.jpg"
...
<Image  src="https://assets.myntassets.com/f_webp,w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2022/9/22/d246ea0a-af18-4a62-a8ef-25e02df352871663841721199-1222.jpg" 
    ...
    backgroundColor:"#fdf3dd", width:"100%", height:"400px"}}>
    {
    data?.map((el)=>(<Layout1 key ={el.id} image={el.image} />
    ))
}
    </div>
...
border:"1px solid transparent",display:"grid" ,
 gridTemplateColumns:"repeat(6,1fr)",marginBottom:"300px"}}>
